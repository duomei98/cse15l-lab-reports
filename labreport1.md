...
I did not need to do this step because I already had VSCode installed from a previous class. If you do not have it installed, you can download it for your computer using this link ([Link](https://code.visualstudio.com/download)), then following the instructions on screen. If installed correctly, you should have something like this:
